function toggleMode() {
    ...
    if (content.innerText == "Dark") {
        ...
        document.getElementsByTagName("body")[0].style.backgroundColor = "#131417";
        ...
        document.cookie = "darkMode=; expires=Fri, 31 Dec 9999 23:59:59 GMT; path=/";
        
        /*Change to light mode*/
    } else {
        console.log("light")
        document.querySelectorAll("*")[0].style = "color: red;";
        ...
        document.cookie = "darkMode=0; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/";
    }
}